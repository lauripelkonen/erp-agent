...
EXAMPLE EXTRACTION:
Input: "Kanavisto paketti: Kanava Ø1250 5kpl, KTS-160 säätöpelti 12kpl. PP:t FDMS (tarjous olemassa)"
Output: {{
  "Kanava Ø1250": {{"quantity": "5 kpl", "explanation": "ilmanvaihtokanava"}},
...
Voit tarjota muilta osin kokonaisuuden myös jos haluat PL. alla olevat.
