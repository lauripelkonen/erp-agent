        ...
        if product_matches:
            ...
            for i, product in enumerate(product_matches, 1):
                ...
                product_data.append([
                    ...
                    f"{line_total:.2f}€",
                    f"{product.get('ai_confidence', 75)}%"
                ])
            ...
            # Column widths optimized for A4 with margins - adjusted to prevent overlap
            col_widths = [
                8*mm,    # Nro
                20*mm,   # Tuotekoodi
                35*mm,   # Tuotenimi
                32*mm,   # Asiakkaan tuote
                11*mm,   # Määrä
                16*mm,   # Yks.hinta
                10*mm,   # Ale-%
                18*mm,   # Yhteensä
            ...
            table_style = [
                ...
                ('ALIGN', (4, 1), (4, -1), 'RIGHT'),  # Määrä
                ('ALIGN', (5, 1), (5, -1), 'RIGHT'),  # Yks.hinta
                ('FONT', (5, 1), (5, -1), 'Helvetica-Bold', 7),  # Bold prices
                ('ALIGN', (6, 1), (6, -1), 'RIGHT'),  # Ale-%
                ('ALIGN', (7, 1), (7, -1), 'RIGHT'),  # Yhteensä
                ('FONT', (7, 1), (7, -1), 'Helvetica-Bold', 7),  # Bold total prices
                ('ALIGN', (8, 1), (8, -1), 'RIGHT'),  # AI-%
            ...
            for i, product in enumerate(product_matches, 1):
                ...
                ai_confidence = product.get('ai_confidence', 75)
                if ai_confidence >= 80:
                    color = colors.green
                ...
                if not is_red_product:
                    table_style.append(('TEXTCOLOR', (8, product_row), (8, product_row), color))
                    table_style.append(('FONT', (8, product_row), (8, product_row), 'Helvetica-Bold', 7))
                ...
                table_style.append(('SPAN', (2, reasoning_row), (6, reasoning_row)))  # Span from product name to discount columns
