      ...
      <div className="max-w-7xl mx-auto px-8">
        <div className="content-stretch flex flex-col gap-16 items-start justify-start relative">
          ...
          <div className="w-full flex justify-center px-4">
            <div className="relative w-full max-w-[563px] mx-auto" style={{ aspectRatio: `${canvas.width}/${canvas.height}`, minHeight: '240px' }}>
              ...
              >
                <img 
                  src="/src/assets/figma/e-logo.png" 
                  alt="ERP Agent Logo" 
              ...
              <div className="absolute" style={{ left: '269px', top: '4px', width: '120px', height: '30px' }}>
                <img 
                  src="/src/assets/figma/image-583129.png" 
                  alt="NetSuite" 
              ...
              <img src="/src/assets/figma/openai-logo.png" alt="OpenAI" className={`absolute ${fadeIconClass}`} style={{ left: '462px', top: '178px', width: '30px', height: '30px' }} />
              <img src="/src/assets/figma/gemini-logo.png" alt="Gemini" className={`absolute ${fadeIconClass}`} style={{ left: '560px', top: '235px', width: '30px', height: '30px' }} />
              <img src="/src/assets/figma/claude-logo.png" alt="Claude" className={`absolute ${fadeIconClass}`} style={{ left: '339px', top: '224px', width: '30px', height: '30px' }} />
              ...
              <div className="absolute" style={{ left: `${iconImage10.x}px`, top: `${iconImage10.y}px`, width: `${iconImage10.w}px`, height: `${iconImage10.h}px` }}>
                <img 
                  src="/src/assets/figma/image-10.png" 
                  alt="App Icon" 
                  className={`w-full h-full object-contain ${fadeIconClass}`}
                />
              </div>
              ...
              >
                <img 
                  src="/src/assets/figma/image-2.png" 
                  alt="App Icon" 
              ...
              <div className="absolute" style={{ left: `${icon583130.x}px`, top: `${icon583130.y}px`, width: `${icon583130.w}px`, height: `${icon583130.h}px` }}>
                <img 
                  src="/src/assets/figma/image-583130.png" 
                  alt="App Icon" 
                  className={`w-full h-full object-contain ${fadeIconClass}`}
                />
              </div>
              ...
              <div className="absolute" style={{ left: `${icon583132.x}px`, top: `${icon583132.y}px`, width: `${icon583132.w}px`, height: `${icon583132.h}px` }}>
                <img 
                  src="/src/assets/figma/image-583132.png" 
                  alt="App Icon" 
                  className={`w-full h-full object-contain ${fadeIconClass}`}
                />
              </div>
